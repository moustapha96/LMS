...
<main class="app-content">
    ...
    <section class="events-page section-padding-large tile table-responsive">
        <div class="container">
            ...
            <div class="card-body">
                <table class="table table-hover table-bordered" id="sampleTable2" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                            ...
                            <td> 
                                <a href="{{ route('course.liste_students',$course) }}" class="comments btn">
                                    <i class="fa fa-user"></i>{{ $course->student_course->count() }} Student(s)</a>
                             </td>

                            <td> 
                               <a href="{{ route('course.quiz',$course) }}" class="students  btn">
                                    <i class="fa fa-question"></i> {{ $course->quiz->count() }} Quiz</a>
                            </td>


                            <td> 
                                <a href="{{ route('course.liste_lessons',$course) }}" class="students btn" >
