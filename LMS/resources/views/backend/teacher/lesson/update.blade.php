    ...
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"> 
                ...
                <a href="{{ route('teacher.course.liste_lessons',$lesson->course) }}" 
                      class="btn btn-outline-success" > <i class="fa fa-list" aria-hidden="true"></i> Liste Leçons</a>
            </li>
    ...
    <section class="events-page section-padding-large tile table-responsive">
        <div class="tile table-responsive">
            ...
            <div class="container">
                ...
                <form enctype="multipart/form-data" action="{{ route('teacher.lesson.updated',$lesson) }}" method="POST" >
                    @csrf
