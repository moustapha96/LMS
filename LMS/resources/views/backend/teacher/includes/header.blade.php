...
<aside class="app-sidebar">
	<div class="app-sidebar__user">
		...
		<div>
			...
			<p class="app-sidebar__user-designation">Formateur</p>
		</div>
	</div>
	<ul class="app-menu">
		...
		<li><a class="app-menu__item {{ is_active($active1, 'dashboard') }}" href="{{ route('home') }}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Tableau de bord</span></a></li>
		 ...
		 <!--Professeur bd à retoucher-->
		 <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users" aria-hidden="true"></i><span class="app-menu__label">Gestion des cours</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="{{ route('teacher.course.index') }}"><i class="icon fa fa-list"></i> Liste Cours</a></li>
                <li><a class="treeview-item" href="{{ route('teacher.course.add') }}"><i class="icon fa fa-plus"> </i> Add cours</a></li>
            </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-qrcode" aria-hidden="true"></i><span class="app-menu__label">quiz</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="{{ route('teacher.quiz.index') }}"><i class="icon fa fa-list"></i>Liste des quiz</a></li>
            </ul>
		</li>
		
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users" aria-hidden="true"></i><span class="app-menu__label">Participants</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="{{ route('teacher.student_listening_course') }}"><i class="icon fa fa-graduation-cap"></i> étudiant Suivant vos Cours</a></li>
            </ul>
        </li>
		...
		<li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview">
			...
			<ul class="treeview-menu">
				<li><a class="treeview-item" href="{{ route('messageTeacher.index') }}">
