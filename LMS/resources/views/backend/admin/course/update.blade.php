    ...
    <section class="events-page section-padding-large tile table-responsive">
        <div class="tile table-responsive">
            ...
            <div class="container">
                ...
                <form enctype="multipart/form-data" action="{{ route('course.updated',$course) }}" method="POST" >
                    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select id="teacher" name="teacher" class="form-control" required>
                                    ...
                                    @foreach($teachers as $teacher )
                                        <option value="{{ $teacher->id }}" {{ $course->teacher_id == $teacher->id ? 'selected': ''  }} > {{ $teacher->user->prenom }} {{ $teacher->user->nom }} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
