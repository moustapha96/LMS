...
<div class="container">
                ...
                <div class="categories-content">
                    <article class="item cat-1">
                        <figure>
                            ...
                            <div class="info">
                                <h3 class="title">
                                    <a href="courses.html">UI Design</a>
                                </h3>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <article class="item cat-2">
                                    <figure>
                                        ...
                                        <div class="info">
                                            <h3 class="title">
                                                <a href="courses.html">UX Design</a>
                                            </h3>
                                ...
                                <article class="item cat-3">
                                    <figure>
                                        ...
                                        <div class="info">
                                            <h3 class="title">
                                                <a href="courses.html">Web Developer</a>
                                            </h3>
        ...
        <!-- Course -->
        <section class="courses courses-2 section-padding-large" style="background-image: url('images/home2-courses-bg.jpg');">
            <div class="container">
                    ...
                    <div class="row">
                            ...
                            <article class="item wow fadeIn" data-wow-delay="0.1s">
                                <div class="item-thumb">
                                    <a href="single-course.html">
                                        <img src="images/home2-course-1.jpg" alt="">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <article class="item wow fadeIn" data-wow-delay="0.3s">
                                <div class="item-thumb">
                                    <a href="single-course.html">
                                        <img src="images/home2-course-2.jpg" alt="">
                                        <span class="overlay"></span>
                                    </a>
                                    <div class="feadtured-course-small">
                                        <a href="#">
                                ...
                                <div class="info">
                                    ...
                                    <p class="course-desc">
                                        Est ante in nibh mauris cursus molestie sit amet volutpat.
                                    </p>
                                    <div class="desc display-flex">
                                        <div class="comments-students">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <article class="item wow fadeIn" data-wow-delay="0.5s">
                                <div class="item-thumb">
                                    <a href="single-course.html">
                                        <img src="images/home2-course-3.jpg" alt="">
                                        <span class="overlay"></span>
                                    </a>
                                    <div class="feadtured-course-small">
                                        <a href="#">
                                ...
                                <div class="info">
                                    <a href="#" class="teacher">Andrea Russell</a>
                                    <h3 class="title">
                                        <a href="single-course.html">SEO Training Course</a>
                                    </h3>
                                    <p class="course-desc">
                                    ...
                                    <div class="desc display-flex">
                                        <div class="comments-students">
                                            <a href="#" class="comments"><i class="fas fa-user"></i>24 Students</a>
                                            <a href="#" class="students"><i class="fas fa-book"></i>30 Lessons</a>
                                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <article class="item wow fadeIn" data-wow-delay="0.1s">
                                <div class="item-thumb">
                                    <a href="single-course.html">
                                        <img src="images/home2-course-4.jpg" alt="">
                                        <span class="overlay"></span>
                                    </a>
                                    <div class="feadtured-course-small">
                                        <a href="#">
                                            <img src="images/home3-tutor-4.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="info">
                                    <a href="#" class="teacher">Jack Crawford</a>
                                    <h3 class="title">
                                        <a href="single-course.html">Input And Interaction</a>
                                    </h3>
                                    <p class="course-desc">
                                        In cursus turpis massa tincidunt dui. Dui nunc mattis enim ut elementum.
                                    </p>
                                    <div class="desc display-flex">
                                        <div class="comments-students">
                                            <a href="#" class="comments"><i class="fas fa-user"></i>26 Students</a>
                                            <a href="#" class="students"><i class="fas fa-book"></i>03 Lessons</a>
                                        </div>
                                        <span class="price free">Free</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <article class="item wow fadeIn" data-wow-delay="0.3s">
                                <div class="item-thumb">
                                    <a href="single-course.html">
                                        <img src="images/home2-course-5.jpg" alt="">
                                        <span class="overlay"></span>
                                    </a>
                                    <div class="feadtured-course-small">
                                        <a href="#">
                                ...
                                <div class="info">
                                    <a href="#" class="teacher">Gabriel Watson</a>
                                    <h3 class="title">
                                    ...
                                    <div class="desc display-flex">
                                        <div class="comments-students">
                                            <a href="#" class="comments"><i class="fas fa-user"></i>40 Students</a>
                                            <a href="#" class="students"><i class="fas fa-book"></i>25 Lessons</a>
                                        </div>
                                        <span class="price notfree">$24.00</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <article class="item wow fadeIn" data-wow-delay="0.5s">
                                <div class="item-thumb">
                                    <a href="single-course.html">
                                        <img src="images/home2-course-6.jpg" alt="">
                                        <span class="overlay"></span>
                                    </a>
                                    <div class="feadtured-course-small">
                                        <a href="#">
                                ...
                                <div class="info">
                                    ...
                                    <div class="desc display-flex">
                                        <div class="comments-students">
                                            <a href="#" class="comments"><i class="fas fa-user"></i>22 Students</a>
            ...
            <div class="container">
                ...
                <div class="home2-testimonials-content">
                    <article class="item">
                        ...
                        <figure>
                            <a href="#">
                                <img src="images/testimonials-5.jpg" alt="Elizabeth King">
                            </a>
                            <h4 class="title">
                                <a href="#">Elizabeth King</a>
                            </h4>
                    ...
                    <article class="item">
                        ...
                        <figure>
                            <a href="#">
                                <img src="images/course-small-1.jpg" alt="Gabriel Watson">
                            </a>
                            <h4 class="title">
                    ...
                    <article class="item">
                        ...
                        <figure>
                            <a href="#">
                                <img src="images/testimonials-6.jpg" alt="Amanda James">
                            </a>
                            <h4 class="title">
                    ...
                    <article class="item display-flex">
                        <div class="info">
                            ...
                            <div class="course-title">
                                <h3 class="title">
                                    <a href="single-event.html">Technology Connection</a>
                                </h3>
                                <span class="price free">Free</span>
                            </div>
                            <div class="meta">
                                <span class="time"><i class="far fa-clock"></i>8:00Am - 18:00Pm</span>
                                <span class="address"><i class="fas fa-map-marker-alt"></i>27th St, New York, NY</span>
                            </div>
                            <p class="desc">
                                In hendrerit gravida rutrum quisque non. Suspendisse faucibus interdum posuere lorem ipsum dolor. Tincidunt lobortis feugiat vivamus at augue eget arcu.
                            </p>
                        </div>
                        <figure>
                            <a href="single-event.html">
                                <img src="images/home2-events-1.jpg" alt="">
                            </a>
                        </figure>
                    </article>
                    <article class="item display-flex">
                        <div class="info">
                            ...
                            <div class="course-title">
                                <h3 class="title">
                                    <a href="single-event.html">AI Development Day</a>
                                </h3>
                                <span class="price notfree">$20.00</span>
                            </div>
                            <div class="meta">
                                <span class="time"><i class="far fa-clock"></i>14:00Pm - 18:00Pm</span>
                                <span class="address"><i class="fas fa-map-marker-alt"></i>27th St, New York, NY</span>
                            </div>
                            <p class="desc">
                                Hendrerit dolor magna eget est lorem. Tempor commodo ullamcorper a lacus vestibulum sed. Cras tincidunt lobortis feugiat vivamus. Senectus et netus et malesuada fames.
                            </p>
                        </div>
                        <figure>
                            <a href="single-event.html">
                                <img src="images/home2-events-2.jpg" alt="">
                            </a>
                        </figure>
                    </article>
                    <article class="item display-flex">
                        <div class="info">
                            ...
                            <div class="course-title">
                                <h3 class="title">
                                    <a href="single-event.html">Creative Development</a>
                                </h3>
                                <span class="price free">Free</span>
                            </div>
                            <div class="meta">
                                <span class="time"><i class="far fa-clock"></i>8:00Am - 16:00Pm</span>
                                <span class="address"><i class="fas fa-map-marker-alt"></i>27th St, New York, NY</span>
                            </div>
                            <p class="desc">
                                Lectus quam id leo in vitae turpis massa sed. Tincidunt lobortis feugiat vivamus at augue eget arcu. Egestas egestas fringilla phasellus faucibus scelerisque eleifend donec pretium.
                            </p>
                        </div>
                        <figure>
                            <a href="single-event.html">
                                <img src="images/home2-events-3.jpg" alt="">
                            </a>
                        </figure>
                    </article>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <article class="item hover-scale">
                                <figure>
                                    <a href="single.html">
                                        <img src="images/home1-blog-1.jpg" alt="">
                                    </a>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <article class="item hover-scale">
                                <figure>
                                    <a href="single.html">
                                        <img src="images/home1-blog-2.jpg" alt="">
                                    </a>
                                    <div class="hover-border">
                                        <a href="single.html">
                                            <i class="fas fa-link"></i>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <article class="item hover-scale">
                                <figure>
                                    <a href="single.html">
                                        <img src="images/home1-blog-3.jpg" alt="">
                                    </a>
                                    <div class="hover-border">
                                        <a href="single.html">
                                            <i class="fas fa-link"></i>
